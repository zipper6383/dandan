...
const About: React.FC = () => {
        ...
        return (
          <div className="prose max-w-none text-gray-800 text-justify leading-9 text-[16px]">
            ...
            <p className="indent-8 mb-6">
              长安慈善会是经政府批准，�?997�?�?6日登记注册成立，是具有独立法人资格的公益性、非营利性社会团体和公募资质的慈善机构，�?A级中国社会团体组织�?            </p>
            <p className="indent-8 mb-6">
              长安慈善会现有会�?人，执行会长兼秘书长1人，副会�?6人（驻会3人），慈善专�?0人（驻会1人），常务理�?6人，理事204人，单位会员119个，个人会员524人。长安慈善会内设一室六部：办公室：综合协调、行政事务、财务管理等；募集部：组织动员、开展国内外公募善款善物；项目部：策划组织实施各类慈善项目；救助部：实施救助社会各类困难群体；宣传部：开展慈善公益宣传，传播慈善文化；网信部：负责官网运行管理并实施各类网络慈善活动，开展网络慈善；联络部：组织联络各类慈善机构、社会团体、爱心企业、志愿者团队开展各类慈善活动，建立健全会员、理事等档案管理工作�?            </p>
            <p className="indent-8 mb-6">
              西安市慈善会自成立以来，认真贯彻落实《中华人民共和国慈善法》，以“扶贫济困、救急助难、弘扬慈善文化、助推社会和谐”为己任，设立各类基�?00余个，投入善款和物资共计�?亿元，实施项目万余个，惠及人民群�?00多万人次。创立了有社会影响的“春节送温暖”、“六一送关爱”、“九九送关怀”、“高考助圆梦”、“慈善便民桥”、“幸福家园工程”等多个品牌项目，受到社会广泛关注和好评�?            </p>
            <p className="indent-8 mb-6">
              西安市慈善会被中华慈善总会授予“突出贡献组织奖”、“中华慈善先进机构奖”、“突出贡献项目奖”；被省民政厅、省人力资源和社会保障厅授予“慈善项目和慈善信托奖”；被省委文明办、省慈善协会授予“三秦善星奖”；被市政府授予“抗击疫情突出贡献社会组织奖”；被市民政局授予“先进基层党组织”等荣誉称号�?            </p>
            <p className="indent-8 mb-6">
              欢迎各级各类组织，爱心企业、爱心人士参与长安慈善，支持长安慈善，监督长安慈善�?            </p>

            <div className="mt-12 text-[16px] text-gray-800 space-y-2">
              <p>爱心捐赠电话�?29-88443055�?29-88868053�?8192168337</p>
              <p>联系人：屈老师</p>
              <p>求助电话�?29-88443061�?7782680763</p>
              <p>地址：长安慈善大厦A�?层（未央区凤城四�?05号）</p>
            </div>
          </div>
        );
      case 'qualifications':
          ...
          <div className="prose max-w-none text-gray-800">
            ...
            <div className="flex flex-col items-center gap-10 mt-8 w-full">
              {config.donationQRs?.qr1 && (
                <div className="flex flex-col items-center gap-2 w-full">
                  <img
                    ...
                    alt={config.donationQRs.title1 || '捐赠二维�?}
              ...
              {config.donationQRs?.qr2 && (
                <div className="flex flex-col items-center gap-2 w-full">
                  <img
                    ...
                    alt={config.donationQRs.title2 || '捐赠二维�?}
                    className="w-full max-w-[320px] h-auto object-contain bg-white"
                  />
              ...
              {!config.donationQRs?.qr1 && !config.donationQRs?.qr2 && (
                <p className="text-gray-400">暂无二维码配�?/p>
              )}
            </div>
          </div>
        );
      default:
        return (
          <div className="flex flex-col items-center justify-center py-20 bg-gray-50 rounded-lg border border-dashed border-gray-300">
            <p className="text-xl text-gray-400 mb-2">🚧 内容建设�?/p>
  ...
  return (
    <div className="bg-white min-h-screen pb-12">
      <SEO title="机构介绍" description="长安慈善会简�? />
