      ...
      <div className="p-4">
        ...
        <div className="flex flex-col items-center mb-5 bg-gray-50 p-3 rounded-lg border border-dashed border-gray-300">
          <img
            ...
            className="w-64 h-64 object-contain mb-2 mix-blend-multiply"
          />
        ...
        <div className="space-y-3 text-sm text-gray-600 border-t border-gray-100 pt-4">
          ...
          <div className="space-y-2 pl-3">
            ...
            <div className="group">
              ...
              <p className="font-mono text-lg text-accent font-bold select-all tracking-wide">
                6230 9183 7456 2109 852
              </p>
            </div>
